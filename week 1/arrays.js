...
let nouns = ['apple', 'sister', 'hammer', 'sun', 'table', 'sky', 'lake', 'friend'];
// indeksai:    0       1         2        3       4        5       6       7    
let helpers = ['in', 'with', 'on', 'my', 'is', 'a', 'the', ' '];
// indeksai:    0       1     2      3     4    5     6     7  
let verbs = ['loves', 'likes', 'flies'];
...
// My sister loves apple
let sentence5 = helpers[3] + helpers[7] + nouns[1] + helpers[7] + verbs[0] + helpers[7] + nouns[0];
console.log(sentence5);
// Friend likes the sun
let sentence6 = nouns[7] + helpers[7] + verbs[1] + helpers[7] + helpers[6] + helpers[7] + nouns[3];
console.log(sentence6)
//My friend flies in the sky
let sentence7 = helpers[3] + helpers[7] + nouns[7] + helpers[7] + verbs[2] + helpers[7] + helpers[0] + helpers[7] + helpers[6] + helpers[7] + nouns[5];
